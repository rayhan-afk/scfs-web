...
<div class="py-8 px-6 md:px-8 w-full space-y-6 relative">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
        ...
        <button wire:click="openModal" class="px-5 py-3 bg-emerald-600 text-white rounded-xl hover:bg-emerald-700 font-bold text-sm shadow-md transition flex items-center justify-center gap-2 focus:ring-4 focus:ring-emerald-100">
