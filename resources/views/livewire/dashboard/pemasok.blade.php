    ...
    @elseif($status_verifikasi === 'disetujui')
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="{{ route('pemasok.inventaris', ['action' => 'tambah']) }}" class="bg-blue-600 text-white font-bold px-6 py-2.5 rounded-xl hover:bg-blue-700 transition-all shadow-lg shadow-blue-200 flex items-center justify-center gap-2">
